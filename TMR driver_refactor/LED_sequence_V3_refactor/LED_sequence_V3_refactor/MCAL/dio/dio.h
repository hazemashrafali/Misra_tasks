 ...
 */	
enu_error_state_t DIO_pinMode	(uint8 port,uint8 pin,enu_pin_direction_t direction);
 ...
 */
enu_error_state_t DIO_writePin		(uint8 port,uint8 pin,enu_pin_value_t value);
 ...
 */
enu_error_state_t DIO_readPin		(uint8 port,uint8 pin,uint8** value);
 ...
 *				INVALID_PIN_ID				:	in case of wrong pin id       
 */
enu_error_state_t DIO_togglePin	(uint8 port,uint8 pin);
 ...
 *				INVALID_DIRECTION			:	in case of wrong direction      
 */	
enu_error_state_t DIO_portMode		(uint8 port,enu_port_direction_t direction);
 ...
 *				INVALID_OPERATION			:	in case of wrong value       
 */
enu_error_state_t DIO_writePort	(uint8 port,enu_port_value_t enu_port_value);
 ...
 *				INVALID_OPERATION			:	in case of passing NULL pointer       
 */
enu_error_state_t DIO_readPort		(uint8 port,uint8** value);
 ...
 *              INVALID_PORT_ID 			:   in case of wrong port id       
 */
enu_error_state_t DIO_togglePort	(uint8 port);
